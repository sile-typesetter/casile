SILE.registerCommand("titlepage", function (options, content)
  ...
  SILE.call("center", {}, function ()
    ...
    SILE.call("cabook:titlepage-title-font", { size = "7%pw" }, function ()
      SILE.call("wraptitle", {}, { CASILE.metadata.title } )
    end)
    SILE.call("skip", { height = "9%ph" })
    if CASILE.metadata.subtitle then
      SILE.call("cabook:titlepage-subtitle-font", { size = "4%pw" }, function ()
...
SILE.registerCommand("halftitlepage", function (options, content)
  ...
  SILE.call("center", {}, function ()
    ...
    SILE.call("cabook:titlepage-title-font", { size = "4.5%pw" }, function ()
...
SILE.registerCommand("chapter", function (options, content)
  ...
  SILE.call("center", {}, function ()
    SILE.settings.temporarily(function ()
      ...
      SILE.call("cabook:chapterfont", {}, content)
    end)
  end)
...
SILE.registerCommand("section", function (options, content)
  ...
  SILE.settings.temporarily(function ()
    SILE.call("noindent")
    SILE.call("cabook:sectionfont", {}, function ()
...
SILE.registerCommand("subsection", function (options, content)
  ...
  SILE.settings.temporarily(function ()
    SILE.call("noindent")
    SILE.call("cabook:sectionfont", { size = "0.9em"}, function ()
      SILE.call("uppercase", {}, content)
    end)
  end)
  SILE.call("novbreak")
...
SILE.registerCommand("subsubsection", function (options, content)
  ...
  SILE.settings.temporarily(function ()
    SILE.call("noindent")
    SILE.call("cabook:sectionfont", { size = "0.8em"}, function ()
      SILE.call("uppercase", {}, content)
    end)
  end)
  SILE.call("novbreak")
...
SILE.registerCommand("part", function (options, content)
  ...
  SILE.call("set-counter", { id = "footnote", value = 1})
  SILE.call("center", {}, function ()
    SILE.call("cabook:partnumfont", { size = "5%pw" }, function ()
      SILE.call("hbox")
      SILE.call("skip", { height = "10%ph" })
      SILE.call("book:sectioning", {
        numbering = options.numbering,
    ...
    SILE.call("medskip")
    SILE.Commands["cabook:partfont"]({ size = "4%pw" }, content);
    SILE.call("medskip")
...
SILE.registerCommand("subparagraph", function (options, content)
  ...
  SILE.call("skip", { height = "-8pt" })
  SILE.call("novbreak")
  SILE.Commands["cabook:subparagraphfont"]({}, function ()
