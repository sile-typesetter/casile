...
SILE.registerCommand("listarea", function (options, content)
  ...
  SILE.settings.temporarily(function ()
    SILE.settings.set("document.rskip", SILE.nodefactory.newGlue(options.rskip or tostring(SILE.settings.get("document.parindent").width)))
    SILE.settings.set("document.lskip", SILE.nodefactory.newGlue(options.lskip or tostring(SILE.settings.get("document.parindent").width)))
