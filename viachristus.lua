...
SILE.registerCommand("footnote:counter", function(options, content)
  SILE.call("noindent")
  SILE.typesetter:pushGlue({ width = SILE.length.parse("0pt") - SILE.length.parse(options.indent) })
  SILE.Commands["rebox"]({ width = SILE.length.parse(options.indent) }, function ()
