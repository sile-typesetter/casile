...
SILE.registerCommand("quote", function (options, content)
  ...
  SILE.settings.temporarily(function ()
    SILE.call("noindent")
    SILE.settings.set("document.rskip", SILE.nodefactory.glue(options.setback))
    SILE.settings.set("document.lskip", SILE.nodefactory.glue(options.setback))
    SILE.settings.set("current.parindent", SILE.nodefactory.glue())
    SILE.settings.set("document.parindent", SILE.nodefactory.glue())
    SILE.settings.set("document.parskip", SILE.nodefactory.vglue("1.5ex"))
    SILE.process(content)
