SILE.registerCommand("frontcover", function ()
  ...
  SILE.call("color", { color = "#FFFFFF" }, function ()
    SILE.call("center", {}, function ()
      SILE.call("hbox")
      SILE.call("vfill")
      SILE.call("cabook:partnumfont", { size = "7%pmed" }, function ()
        SILE.call("wraptitle", {}, { CASILE.metadata.title })
      end)
      SILE.call("skip", { height = "7%pmin" })
      SILE.call("cabook:titlepage-title-font", { size = "5%pmed" }, function ()
        SILE.call("wrapsubtitle", {}, { CASILE.metadata.subtitle })
      end)
      SILE.call("vfill")
      SILE.call("vfill")
      SILE.call("cabook:partnumfont", { size = "6%pmed", weight = 300 }, { CASILE.metadata.creator[1].text })
    end)
    SILE.call("par")
	SILE.call("vfill")
    SILE.call("break")
...
SILE.registerCommand("backcover", function ()
  ...
  SILE.call("color", { color = "#FFFFFF" }, function ()
    ...
    SILE.settings.temporarily(function ()
      ...
      SILE.call("cabook:sansfont", { size = "3.4%fw", language = "tr", weight = 600 })
...
SILE.registerCommand("spine", function ()
  ...
  SILE.call("color", { color = "#FFFFFF" }, function ()
    SILE.call("center", {}, function ()
      ...
      SILE.call("cabook:partnumfont", { size = "30%fh", weight = 300 },  { CASILE.metadata.creator[1].text })
      SILE.call("par")
    end)
  end)
end)
